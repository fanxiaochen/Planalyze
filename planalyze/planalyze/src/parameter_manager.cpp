...
ParameterManager::ParameterManager(void)
  ...
  leaf_component_size_threshold_(new IntParameter("Leaf Component Size", "Leaf Component Size", 128, 4, 1024)),
  stem_component_size_threshold_(new IntParameter("Stem Component Size", "Stem Component Size", 64, 4, 1024)),
